...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12" >
        ...
        <label class="radio-inline">
            <input type="radio" name="quickget" class="checkUrl"  value="1" <?php  if($item['quickget'] == 1) { ?>checked="true"<?php  } ?> /> 可以
        </label>
        <label class="radio-inline">
            <input type="radio" name="quickget" class="checkUrl"  value="0" <?php  if($item['quickget'] == 0) { ?>checked="true"<?php  } ?>/> 不可以
        </label>
...
<div class="form-group" <?php  if($item['quickget'] == 0) { ?> style="display:none" <?php  } ?> id="urllimit">
    <label class="col-lg control-label">领取限制</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('sale.coupon' ,$item) ) { ?>
        <input type="text" name="url_limit" class="form-control" value="<?php  echo $item['url_limit'];?>"  />
        <span class='help-block'>链接领取限制</span>
        <?php  } else { ?>
        <div class='form-control-static'><?php  echo $item['url_limit'];?></div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12" >
        ...
        <span class='help-block'>会员是否可以在领券中心直接领取或购买&#28304;&#30721;&#26469;&#33258;&#28304;&#30721;&#37096;&#33853;&#104;&#116;&#116;&#112;&#115;&#58;&#47;&#47;&#119;&#119;&#119;&#46;&#121;&#109;&#97;&#98;&#108;&#46;&#99;&#111;&#109;&#47;</span>
