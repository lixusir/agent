...
<!-- H5后台添加图片热区 -->
<script type="text/html" id="tpl_edit_hotarea">
    <div class="form-group">
        <div class="col-sm-2 control-label">上下边距</div>
        <div class="col-sm-10">
            <div class="form-group">
    ...
    <div class="form-items" data-min="1">
        <div class="inner" id="form-items">
            <div class="item-image "  style="margin-bottom: 10px;position: relative;">
                <img class="hotImg addHotarea" style="height: auto;width: 100%;" src="<%imgsrc params.bgimg%>" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.jpg';" id="show-hotarea-bgimg"/>
                <%each data as item%>
                <div class="bigHot" style="height: <%item.height%>; width: <%item.width%>; top: <%item.top%>; left: <%item.left%>;z-index:<%item.zIndex%>;" data-href=<%item.href%>;><div><%item.title%></div></div>
                <%/each%>
            </div>
            <div class="item" data-id="<%itemid%>">
                <!--                <span class="btn-del" title="删除"></span>-->
                <div class="item-form">
                    <div class="input-group" style="margin-bottom:0px; ">
                        <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="bgimg" value="<%params.bgimg%>" id="bgimg" />
                        <span data-input="#bgimg" data-img="#show-hotarea-bgimg" data-toggle="selectImg" class="input-group-addon btn btn-default">选择图片</span>
                    </div>
                </div>
            </div>
            <div class="hotareaModal" style="display: none;">
                <div class="hotareaCont">
                    <div class="hotHeader">
                        <div class="header-inner">热区编辑器</div>
                        <span class="hotClose">×</span>
                    </div>
                    <div class="hotBody">
                        <ul class="step">
                            <li class="step-item">
                                <div class="item-circle">1</div>
                                <div class="item-text">添加热区</div>
                                <img src="../addons/ewei_shopv2/plugin/diypage/static/images/default/point.png" alt="">
                            </li>
                            <li class="step-item">
                                <div class="item-circle">2</div>
                                <div class="item-text">调整热区大小和位置</div>
                                <img src="../addons/ewei_shopv2/plugin/diypage/static/images/default/point.png" alt="">
                            </li>
                            <li class="step-item">
                                <div class="item-circle">3</div>
                                <div class="item-text">设置关联链接</div>
                                <img src="../addons/ewei_shopv2/plugin/diypage/static/images/default/point.png" alt="">
                            </li>
                            <li class="step-item">
                                <div class="item-circle">4</div>
                                <div class="item-text">保存后生效</div>
                            </li>
                        </ul>
                        <div class="min-box">
                            <div class="hotContainer" id="hot1">
                                <img src="<%imgsrc params.bgimg%>" alt="" >
                                <%each data as item%>
                                <div class="draggable dragable-item" data-ischeck="false" style="z-index:<%item.zIndex%>; position:absolute; user-select: auto;top: <%item.top%>;left: <%item.left%>;width: <%item.width%>;height: <%item.height%>;" data-href="<%item.href%>">
                                    ...
                                    <div class="addUrl" data-toggle="selectUrl" data-input="#curl-<%itemid%>">选择链接</div>
                                    <span class="delHot" onclick="deleteItem($(this))">×</span></div>
                                <%/each%>
                            </div>
                        </div>
                    </div>
                    <div class="hotfooter">
                        <div>
                            <button class="btn btn-sm hotsave" >保存</button>
                            <button class="btn btn-primary btn-sm hotAdd addHotarea" data-url="#curl-<%itemid%>">添加热区</button>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div class="btn btn-w-m btn-block btn-default btn-outline addHotarea" data-url="#curl-<%itemid%>" ><i class="fa fa-plus"></i> 添加热区</div>
            </div>
        </div>
...
<!-- 后台添加短视频组件 -->
<script type="text/html" id="tpl_edit_shortVideo">
    <div class="form-group">
        <div class="col-sm-2 control-label">视频样式</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="ratio" value="0" class="diy-bind" data-bind-child="style" data-bind="ratio" data-bind-init="true" <%if style.ratio=='0'%>checked="checked"<%/if%>> 16:9</label>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group">
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="shortPoster" data-bind-init="true" value="<%params.shortPoster%>" id="shortPoster" placeholder="请选择图片" />
                <span data-input="#shortPoster" data-img="#showposter" data-toggle="selectImg" class="input-group-addon btn btn-default">选择图片</span>
            </div>
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.shortPoster%>" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.jpg';" class="img-responsive img-thumbnail" width="150" id="showposter">
            </div>
            <div class="form-control-static">请上传<%if style.ratio=='0'%>16:9<%/if%><%if style.ratio=='1'%>4:3<%/if%><%if style.ratio=='2'%>1:1<%/if%>比例的图片</div>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-2 control-label">上传视频类型</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="upType" value="0" class="diy-bind" data-bind-child="style" data-bind="upType" data-bind-init="true" <%if style.upType=='0'%>checked="checked"<%/if%>> 本地上传</label>
            <label class="radio-inline"><input type="radio" name="upType" value="1" class="diy-bind" data-bind-child="style" data-bind="upType" data-bind-init="true" <%if style.upType=='1'%>checked="checked"<%/if%>> 提取腾讯视频</label>
        </div>
    </div>
    <div class="form-group" <%if style.upType=='1' %> style="display:none;"<%/if%>>
        <div class="col-sm-2 control-label">选择视频</div>
        <div class="col-sm-10">
            <div class="input-group">
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="shortOrignUrl" data-bind-init="true" value="<%params.shortOrignUrl%>" data-url="<%imgsrc params.shortOrignUrl%>" id="shortOrignUrl" placeholder="请选择视频" />
                <span data-input="#shortOrignUrl" data-img="#showvideo" data-toggle="selectVideo" data-network="true" class="input-group-addon btn btn-default">选择视频</span>
            </div>
            <% if params.shortOrignUrl%>
            <div class="input-group">
                <div class="multi-item" style="display: block" title="预览视频" data-toggle="previewVideo" data-input="#shortOrignUrl">
                    <div class="img-responsive img-thumbnail img-video" style="width: 100px; height: 100px; position: relative; text-align: center; cursor: pointer;" src="">
                        <i class="fa fa-play-circle" style="font-size: 60px; line-height: 90px; color: #999;"></i>
                    </div>
                    <em class="close" title="移除视频" data-toggle="setNull" data-element="#shortOrignUrl">×</em>
                </div>
            </div>
            <%/if%>
        </div>
    ...
    <div class="form-group" <%if style.upType=='0' %> style="display:none;"<%/if%>>
        <div class="col-sm-2 control-label">输入视频链接</div>
        <div class="col-sm-10">
            <div class="input-group col-sm-12">
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="shortVideourl" data-bind-init="true" value="<%params.shortVideourl%>" data-url="<%imgsrc params.shortVideourl%>" id="shortVideourl" placeholder="请输入视频地址" />
            </div>
        </div>
    </div>
</script>
...
<!-- 后台详情短视频 -->
<script type="text/html" id="tpl_edit_detailVideo">
    <div class="form-group">
        <div class="col-sm-2 control-label">视频样式</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="ratio" value="0" class="diy-bind" data-bind-child="style" data-bind="ratio" data-bind-init="true" <%if style.ratio=='0'%>checked="checked"<%/if%>> 16:9</label>
    ...
    <div class="form-group" <%if style.upType=='1' %> style="display:none;"<%/if%>>
        ...
        <div class="col-sm-10">
            <div class="input-group">
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="detailOrignUrl" data-bind-init="true" value="<%params.detailOrignUrl%>" data-url="<%imgsrc params.detailOrignUrl%>" id="detailOrignUrl" placeholder="请选择视频" />
                <span data-input="#detailOrignUrl" data-img="#showvideo" data-toggle="selectVideo" data-network="true" class="input-group-addon btn btn-default">选择视频</span>
            </div>
            <% if params.shortOrignUrl%>
            <div class="input-group">
                <div class="multi-item" style="display: block" title="预览视频" data-toggle="previewVideo" data-input="#detailOrignUrl">
                    <div class="img-responsive img-thumbnail img-video" style="width: 100px; height: 100px; position: relative; text-align: center; cursor: pointer;" src="">
                        <i class="fa fa-play-circle" style="font-size: 60px; line-height: 90px; color: #999;"></i>
                    </div>
                    <em class="close" title="移除视频" data-toggle="setNull" data-element="#detailOrignUrl">×</em>
                </div>
            </div>
            <%/if%>
        </div>
    ...
    <div class="form-group" <%if style.upType=='0' %> style="display:none;"<%/if%>>
        ...
        <div class="col-sm-10">
            <div class="input-group col-sm-10">
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="detailVideourl" data-bind-init="true" value="<%params.detailVideourl%>" data-url="<%imgsrc params.detailVideourl%>" id="detailVideourl" placeholder="请输入视频地址" />
            </div>
        </div>
    </div>
</script>
