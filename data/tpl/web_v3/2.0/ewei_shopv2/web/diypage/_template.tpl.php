...
<!-- H5后台添加热区展示创建 -->
<script type="text/html" id="tpl_show_hotarea">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-banner" style="padding: <%style.paddingtop||'10'%>px <%style.paddingleft || '10'%>px;">
            <img src="<%imgsrc params.bgimg%>" />
        </div>
    </div>
</script>
<!-- H5热区添加ending -->
...
<!-- 后台添加短视频展示创建 -->
<script type="text/html" id="tpl_show_shortVideo">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-video style<%style.ratio%>" style='background-image: url("<%imgsrc(params.shortPoster) || "../addons/ewei_shopv2/plugin/diypage/static/images/default/videocover.png"%>")'></div>
    </div>
</script>
<!-- 短视频ending -->

<!--  后台详情页短视频创建 -->
<script type="text/html" id="tpl_show_detailVideo">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-video style<%style.ratio%>" style='background-image: url("<%imgsrc(params.shortPoster) || "../addons/ewei_shopv2/plugin/diypage/static/images/default/videocover.png"%>")'></div>
    </div>
</script>
