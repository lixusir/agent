...
<div class="form-group" >
    <label class="col-sm-2 control-label">首图视频类型</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        <label class="radio-inline"><input type="radio" name="video_type" value="0"  <?php  if($item['video_type']==0) { ?>checked="true"<?php  } ?>/> 不设置</label>
        <label class="radio-inline"><input type="radio" name="video_type" value="1"  <?php  if(($item['video_type'] == 1) || (empty($item['video_type']) && $item['video_type']!=0 && !empty($item['video']) )) { ?>checked="true"<?php  } ?>/> 本地上传</label>
        <label class="radio-inline"><input type="radio" name="video_type" value="2" <?php  if($item['video_type'] == 2) { ?>checked="true"<?php  } ?>   /> 提取腾讯视频</label>
        <span class="help-block">提示：目前视频来源仅支持腾讯视频</span>
        <?php  } else { ?>
        <div class='form-control-static'><?php  if(empty($item['video_type'])) { ?>否<?php  } else { ?>是<?php  } ?></div>
        <?php  } ?>
    </div>
</div>
<?php  if(p('app')) { ?>
<div class="form-group" id="video_dom" <?php  if($item['video_type'] == 0 ||  $item['video_type'] == 2 ) { ?> style="display: none" <?php  } ?>>
<label class="col-sm-2 control-label must">上传视频</label>
<div class="col-sm-9 col-xs-12">
    <?php if( ce('goods' ,$item) ) { ?>
...
<div class="form-group" id="video_url_dom" <?php  if($item['video_type'] == 0 ||  $item['video_type'] == 1) { ?> style="display: none" <?php  } ?>>
<label class="col-sm-2 control-label must">视频地址</label>
<?php if( ce('goods' ,$item) ) { ?>
<div class="col-sm-9">
    <input type="text" name="video_url" id="video_url" class="form-control" value="<?php  echo $item['video_url'];?>" data-rule-required="true"/>
    <div class="help-block"></div>
</div>
<?php  } else { ?>
<div class='form-control-static'><?php  echo $item['video_url'];?></div>
<?php  } ?>
</div>
<div class="form-group" id="video_cut" <?php  if($item['video_type'] == 0 ) { ?> style="display: none" <?php  } ?>>
<label class="col-sm-2 control-label">视频封面图</label>
<div class="col-sm-9 col-xs-12 gimgs">
    <?php if( ce('goods' ,$item) ) { ?>
    <?php  echo tpl_form_field_image2('video_cut',$item['video_cut'])?>
    <span class="help-block">设置后商品首图默认显示视频，不自动播放</span>
    <?php  } else { ?>
    <a href='<?php  echo tomedia($item["video_cut"])?>' target='_blank'>
        <img src="<?php  echo tomedia($item['video_cut'])?>" style='height:100px;border:1px solid #ccc;padding:1px;float:left;margin-right:5px;' />
    </a>
    <?php  } ?>
</div>
</div>
...
<?php  } ?>
<?php  echo $item['type'];?>
<div class="form-group" <?php  if(($item['type'] == 2  || $item['isverify']==2 || $item['type'] == 3 || $item['type'] == 5 || $item['type'] == 10)) { ?>style="display: none;"<?php  } ?>>
<label class="col-sm-2 control-label">运费显示</label>
<div class="col-sm-9 col-xs-12">
    <?php if( ce('goods' ,$item) ) { ?>
    <label class="radio-inline"><input type="radio" name="isshowfreight" value="1" <?php  if($item['isshowfreight'] == 1) { ?>checked="true"<?php  } ?>   /> 显示</label>
    <label class="radio-inline"><input type="radio" name="isshowfreight" value="0" <?php  if(empty($item['isshowfreight'])) { ?>checked="true"<?php  } ?>/> 隐藏</label>
    <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <?php  } ?>
        <div class="help-block">订单中有多个不同售后选项的商品时，整单发起售后只能满足相同选项条件进行售后&#28304;&#30721;&#26469;&#33258;&#28304;&#30721;&#37096;&#33853;&#104;&#116;&#116;&#112;&#115;&#58;&#47;&#47;&#119;&#119;&#119;&#46;&#121;&#109;&#97;&#98;&#108;&#46;&#99;&#111;&#109;&#47;</div>
    </div>
</div>
...
<script language="javascript">
    ...
    $(function () {
        ...
        $('input[name=video_type]').off('click').on('click',function () {
            if ($(this).val() ==0)
            {
                $('#video_dom').hide();
                $('#video_url_dom').hide();
