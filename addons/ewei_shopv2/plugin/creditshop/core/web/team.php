...
class Team_EweiShopV2Page extends PluginWebPage
{
    ...
    public function detail()
    {
        ...
        $goods = pdo_fetch('select g.thumb,g.credit,g.id,g.title,g.set_score from '.tablename('ewei_shop_creditshop_log')." as l left join ".tablename('ewei_shop_creditshop_goods')." as g on l.goodsid=g.id where l.id=:id",array(':id'=>$oid));
